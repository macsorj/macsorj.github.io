...
#initials_table a {
    ...
    -webkit-border-radius: 5px;
    border-radius: 5px;
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=ffffff&to=e0e0e0);
...
#initials_table a.active {
    ...
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=bbbbbb&to=ffffff);
background-size: 100% 100%;
...
th {
    ...
    color: #000;
    background: #f3f3f3;
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=ffffff&to=cccccc);
background-size: 100% 100%;
...
input.button {
    ...
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=f8f8f8&to=d8d8d8);
background-size: 100% 100%;
...
input.button:hover {
    position: relative;
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=fff&to=ddd);
background-size: 100% 100%;
...
input.button:active {
    position: relative;
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=eee&to=ddd);
background-size: 100% 100%;
...
select[multiple] {
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=ffffff&to=f2f2f2);
background-size: 100% 100%;
...
table tr.marked:not(.nomarker) {
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=ced6df&to=b6c6d7);
background-size: 100% 100%;
...
.menucontainer {
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=ffffff&to=dcdcdc);
background-size: 100% 100%;
...
.buttonlinks a:hover,
a.button:hover {
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=ffffff&to=dddddd);
background-size: 100% 100%;
...
/* main page */
#maincontainer {
    /* background-image: url(/phpmyadmin/themes/pmahomme/img/logo_right.png); */
...
/**
 ...
 .ajax_notification {
    ...
    left: 0;
    right: 0;
    background-image: url(/phpmyadmin/themes/pmahomme/img/ajax_clock_small.gif);
    background-repeat: no-repeat;
...
.cPointer {
    background: url(/phpmyadmin/themes/pmahomme/img/col_pointer.png);
    height: 20px;
...
.coldrop {
    background: url(/phpmyadmin/themes/pmahomme/img/col_drop.png);
    cursor: pointer;
    height: 16px;
    margin-left: .3em;
    margin-top: .3em;
...
.navigation {
    ...
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=eeeeee&to=cccccc);
background-size: 100% 100%;
...
.navigation input.edit_mode_active {
    ...
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=333333&to=555555);
background-size: 100% 100%;
...
.cEdit .edit_box_posting {
    background: #FFF url(/phpmyadmin/themes/pmahomme/img/ajax_clock_small.gif) no-repeat right center;
    padding-right: 1.5em;
}

.cEdit .edit_area_loading {
    background: #FFF url(/phpmyadmin/themes/pmahomme/img/ajax_clock_small.gif) no-repeat center;
    height: 10em;
}
...
.saving_edited_data {
    background: url(/phpmyadmin/themes/pmahomme/img/ajax_clock_small.gif) no-repeat left;
    padding-left: 20px;
}
...
span.drag_icon {
    display: inline-block;
    background-image: url('/phpmyadmin/themes/pmahomme/img/s_sortable.png');
...
th.headerSortUp .sorticon, th.headerSortDown:hover .sorticon {
    background-image: url(/phpmyadmin/themes/pmahomme/img/s_desc.png);
}

th.headerSortDown .sorticon, th.headerSortUp:hover .sorticon {
    background-image: url(/phpmyadmin/themes/pmahomme/img/s_asc.png);
}
...
#pma_navigation {
    ...
    left: 0;
    height: 100%;
    background: url(/phpmyadmin/themes/pmahomme/img/left_nav_bg.png) repeat-y right 0 #f3f3f3;
    color: #000;
    z-index: 800;
}
...
#pma_navigation_db_select select {
    background: url("/phpmyadmin/themes/pmahomme/img/select_bg.png") repeat scroll 0 0;
    -webkit-border-radius: 2px;
    border-radius: 2px;
    border: 1px solid #bbb;
...
.pmd_tab .header {
    background-image: url(/phpmyadmin/themes/pmahomme/img/pmd/Header.png);
...
.tab_zag_2 {
    background-image: url(/phpmyadmin/themes/pmahomme/img/pmd/Header_Linked.png);
    background-repeat: repeat-x;
    text-align: center;
    cursor: move;
    padding: 1px;
...
.pmd_Tabs {
    ...
    text-align: left;
    background-color: #fff;
    background-image: url(/phpmyadmin/themes/pmahomme/img/pmd/left_panel_butt.png);
...
.small_tab {
    ...
    color: #fff;
    background-image: url(/phpmyadmin/themes/pmahomme/img/pmd/small_tab.png);
    cursor: default;
    text-align: center;
    font-weight: bold;
    padding-left: 2px;
...
.frams1 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/1.png) no-repeat right bottom;
}

.frams2 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/2.png) no-repeat left bottom;
}

.frams3 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/3.png) no-repeat left top;
}

.frams4 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/4.png) no-repeat right top;
}

.frams5 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/5.png) repeat-x center bottom;
}

.frams6 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/6.png) repeat-y left;
}

.frams7 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/7.png) repeat-x top;
}

.frams8 {
    background: url(/phpmyadmin/themes/pmahomme/img/pmd/8.png) repeat-y right;
}
...
.pmd_header {
    ...
    margin: 0;
    padding: 0;
    background-image: url(/phpmyadmin/themes/pmahomme/img/pmd/top_panel.png);
...
#layer_menu_sizer {
    background-image: url(/phpmyadmin/themes/pmahomme/img/pmd/resize.png);
    cursor: ew-resize;
}
...
a.trigger {
    ...
    background: #333 url(/phpmyadmin/themes/pmahomme/img/pmd/plus.png) 85% 55% no-repeat;
...
a.trigger:hover {
    color: #080808;
    background: #fff696 url(/phpmyadmin/themes/pmahomme/img/pmd/plus.png) 85% 55% no-repeat;
    border: 1px solid #999;
}

a.active.trigger {
    background: #222 url(/phpmyadmin/themes/pmahomme/img/pmd/minus.png) 85% 55% no-repeat;
    z-index: 999;
}

a.active.trigger:hover {
    background: #fff696 url(/phpmyadmin/themes/pmahomme/img/pmd/minus.png) 85% 55% no-repeat;
}
...
ul.resizable-menu li:hover {
    background-image: url(/phpmyadmin/themes/svg_gradient.php?from=ffffff&to=e5e5e5);
background-size: 100% 100%;
...
ul.resizable-menu ul li {
    width: 100%;
            ...
            width: 16px;
            height: 16px;
            background-image: url('/phpmyadmin/themes/pmahomme/img/sprites.png?v=4.7.4') !important;
